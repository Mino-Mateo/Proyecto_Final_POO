...
public class Panel_Administrador_Stock extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Panel_Administrador_Stock
     */
    ...
    public static void main(String args[]) {
        ...
        {
            java.util.logging.Logger.getLogger(Panel_Administrador_Stock.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Panel_Administrador_Stock().setVisible(true);
            }
        });
    }
